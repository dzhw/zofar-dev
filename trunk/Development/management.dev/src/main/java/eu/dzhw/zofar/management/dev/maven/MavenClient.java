...
//import eu.dzhw.zofar.management.dev.file.system.impl.Temp;
...
public class MavenClient {
	...
	private MavenClient() {
		super();
		// this.fileHandler = new Temp();
//		this.localRepository = new File(DirectoryClient.getInstance().getTemp() + File.separator + "zofarrepository");
	}
	...
	private File getMavenHome() {
		...
		if (!mavenDir.exists()) {
			System.out.println("Download Maven");
