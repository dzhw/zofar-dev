...
public class BugzillaClient {
	...
	public boolean addAttachement(final BugzillaConnector conn, final Attachment attachment, final Bug bug) {
		// LOGGER.warn("Method disabled because aAdding an attachment causes com.j2bugzilla.base.BugzillaException: An unknown error was encountered; fault code: 0 : Null values aren't supported, if isEnabledForExtensions() == false");
		// Bug updatedBug = getBug(conn,bug.getAlias());
