...
public class WriterDocument {
	...
	public WriterDocument(final String documentPath) throws Exception {
		...
		// final InputStream is = classloader.getResourceAsStream(documentPath);
	...
	// */
	// @Deprecated
	// public OdfTable addTable(final String text, final String[] columnLabels,
	// final OdfTextElement[][] data) throws Exception {
	// if (this.doc == null)
	// return null;
	// this.addText(text);
	// return this.createTable(UUID.randomUUID().toString(), columnLabels,
	// data);
	// }
	...
	private OdfTable createTable(final String tablename, final String[] colNames, final OdfTextElement[][] data) {
		...
		table.setTableName(tablename);
		// table.getOdfElement().setStyleName(coreTableStyleName);
		int rowIndex = 0;
	...
	public OdfTextParagraph addText(final String text) throws Exception {
		// return this.addTextBlock(text, "Text");
	...
	public OdfTextParagraph addTextPair(final String text1, final String text2, final String glue) throws Exception {
		// return this.addPair(text1, text2, glue, "Text");
	...
	// public OdfDrawImage addImage(final File imageFile) throws Exception{
	// if (this.doc == null)
	// return null;
	//
	// // insert a frame
	...
	// image.newImage(imageFile.toURI());
	// return image;
	// }
...
//		OdfWhitespaceProcessor.appendText(paragraph, "blabla\n");
		//
		//
		OdfPackage pkg = this.doc.getPackage();
		// // loads the image from the URL and inserts the image in the package,
		// pkg.insert(imageFile.toURI(), "Pictures/"+imageFile.getName(), "image/png");
		//
		...
		// String packagePath = image.newImage(imageFile.toURI());
		// double width = maxImageWidth;
		// double ratio = image1.getRectangle().getWidth() / width;
		// double newHeight = image1.getRectangle().getHeight() / ratio;
		//
		// image1.setRectangle( new FrameRectangle( 0, 0, width, newHeight,
	...
	public void exportAsPdf(final String documentPath) throws Exception {
		...
		// final OutputStream out = new FileOutputStream(new File(documentPath));
