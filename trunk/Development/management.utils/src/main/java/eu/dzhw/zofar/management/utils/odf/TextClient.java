...
//	 *             the exception
//	 */
//	public void addImage(final WriterDocument doc,final File image) throws Exception {
//		if (doc == null)
//			return;
//		doc.addImage(image);
//	}
	 ...
	 */
//	@Deprecated
//	public OdfTable addTable(final WriterDocument doc, final String title, final String[] columnLabels, final OdfTextElement[][] data) throws Exception {
//		if (doc == null)
//			return null;
//		return doc.addTable(title, columnLabels, data);
//	}
