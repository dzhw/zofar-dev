...
//			.getLogger(ZofarDifferentialMatrixResponseDomainRenderer.class);
...
//	@Override
	...
	protected synchronized Integer getNumberOfMissingOptions(final FacesContext context,
			final UIComponent component) {
		Integer back = 0;
		UISingleChoiceMatrixItem firstItem = null;
		for (final UIComponent child : component.getChildren()) {
...
//		LOGGER.info("isShowValues {} ({})",component.getId(),isShowValues(context, component));
