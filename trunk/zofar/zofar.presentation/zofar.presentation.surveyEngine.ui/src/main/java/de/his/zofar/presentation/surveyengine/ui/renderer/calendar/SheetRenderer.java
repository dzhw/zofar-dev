...
public class SheetRenderer extends Renderer {
	...
	@Override
	public synchronized void encodeBegin(FacesContext context, UIComponent component) throws IOException {
	...
	@Override
	public synchronized void encodeEnd(FacesContext context, UIComponent component) throws IOException {
		if (!component.isRendered())
			return;
		final ResponseWriter writer = context.getResponseWriter();
	...
	private synchronized UICalendarLegend getLegend(UIComponent component) {
		if (component == null)
			return null;
