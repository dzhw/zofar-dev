 ...
 *
 */
//@FacesRenderer(componentFamily = MultipleChoiceResponseDomain.COMPONENT_FAMILY, rendererType = ORIZofarVerticalCheckboxResponseDomainRenderer.RENDERER_TYPE)
...
//		final boolean hasRowClasses = rowClasses.length > 0;
	...
	public synchronized void encodeChildren(final FacesContext context,
		...
		for (final UIComponent child : component.getChildren()) {
			...
			LOGGER.debug("child {} {} ",child.getClass(),child.getRendererType());
