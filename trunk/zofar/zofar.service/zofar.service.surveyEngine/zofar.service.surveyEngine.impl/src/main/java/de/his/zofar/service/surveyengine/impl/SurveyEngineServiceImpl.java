...
//		final ParticipantEntity mapped = new ParticipantEntity();
//		mapped.setId(participant.getId());
//		mapped.setPassword(participant.getPassword());
//		mapped.setToken(participant.getToken());
//		mapped.setVersion(participant.getVersion());
//		
...
//			final Participant part = entry.getValue().getParticipant();
//			if(part != null){
//				final ParticipantEntity partEntity = new ParticipantEntity();
//				partEntity.setId(part.getId());
//				partEntity.setPassword(part.getPassword());
//				partEntity.setToken(part.getToken());
//				partEntity.setVersion(part.getVersion());
//				entity.setParticipant(partEntity);
//			}
//			mapped.addSurveyData(surveyDataDao.saveAndFlush(entity));
//		}
//		
//		final ParticipantEntity saved = this.participantDao.save(mapped);
//		
//		final Participant back = new Participant();
//		back.setId(saved.getId());
//		back.setPassword(saved.getPassword());
//		back.setToken(saved.getToken());
//		back.setVersion(saved.getVersion());
//		
//		for(final Map.Entry<String,SurveyDataEntity> entry : saved.getSurveyData().entrySet()){
//			final SurveyData entity = new SurveyData();
//			entity.setId(entry.getValue().getId());
//			entity.setValue(entry.getValue().getValue());
//			entity.setVariableName(entry.getValue().getVariableName());
//			entity.setVersion(entry.getValue().getVersion());
//			final ParticipantEntity part = entry.getValue().getParticipant();
//			if(part != null){
//				final Participant partEntity = new Participant();
//				partEntity.setId(part.getId());
//				partEntity.setPassword(part.getPassword());
//				partEntity.setToken(part.getToken());
//				partEntity.setVersion(part.getVersion());
