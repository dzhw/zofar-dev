...
//    private SessionController session;
	...
	private Object evaluate(Object key) {
		if (key == null)
			return null;
		// LOGGER.info("evaluate ({}) {}",key.getClass(),key);
		Object tmp = null;
...
//	public Object followLink(final String id,final boolean flag) {
//		if(flag){
//			if(this.elMap.containsKey(id)){
//				final String[] expression = this.elMap.get(id);
//				if((expression != null)&&(expression.length == 2)){
//					JsfUtility.getInstance().evaluateValueExpression(FacesContext.getCurrentInstance(), "#{"+expression[0]+".setStringValue('"+expression[1]+"')}", String.class);
//				}
//			}
//		}
//		return this.getLinkById(id);
