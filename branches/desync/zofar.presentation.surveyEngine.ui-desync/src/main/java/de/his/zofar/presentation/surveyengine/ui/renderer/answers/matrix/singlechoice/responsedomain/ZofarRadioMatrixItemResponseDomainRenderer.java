...
public abstract class ZofarRadioMatrixItemResponseDomainRenderer extends
	...
	protected void renderLabel(final SingleOption option,
	...
	protected boolean encodeOpenQuestion(final FacesContext context, final UIComponent component,final String pId,final String qId,final String rId)
			throws IOException {
		if (!component.isRendered()) {
			return false;
		}
	...
	private void insertJavaScript(final FacesContext context,final UIComponent component,final String pId,final String qId,final String rId,final String oId) throws IOException {
		final ResponseWriter writer = context.getResponseWriter();
	 ...
	 * @return
	 */
	protected String getHeaderMinWidth(final int itemCount) {
