...
public abstract class ZofarResponseDomainRenderer extends Renderer {
     ...
     * @throws IOException
     */
    protected void startTable(final ResponseWriter writer,
            final UIComponent component) throws IOException {
    	this.startTable(writer,component,null);
    }
    ...
    protected void startTable(final ResponseWriter writer,
        ...
        writer.writeAttribute("class", (ZofarResponseDomainRenderer.RESPONSEDOMAIN_CSS_CLASS+" "+additionalClasses).trim(), null);
     ...
     * @throws IOException
     */
    protected void endTable(final ResponseWriter writer) throws IOException {
     ...
     * @return
     */
    protected String[] itemClassesToArray(final String itemClasses) {
