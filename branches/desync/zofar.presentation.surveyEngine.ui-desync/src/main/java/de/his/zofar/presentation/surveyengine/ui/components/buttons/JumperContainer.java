...
public class JumperContainer extends UINamingContainer{
	...
	public String getRendererType() {
		...
		if(separatorKey != null){
			if(separatorKey.equalsIgnoreCase("side"))return SideNavRenderer.RENDERER_TYPE;
			if(separatorKey.equalsIgnoreCase("top"))return BreadCrumbNavRenderer.RENDERER_TYPE;
		}
		return null;
	}
}
