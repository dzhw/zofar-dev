...
public class TileRenderer extends Renderer {
	...
	private void slotHelper(final FacesContext context, final String name,
...
//		final String hiddenStyle = "";
	...
	private UIComponent getSlotCheck(UIComponent component) {
		if (component == null)
			return null;
	...
	private void insertJavaScript(final FacesContext context,
