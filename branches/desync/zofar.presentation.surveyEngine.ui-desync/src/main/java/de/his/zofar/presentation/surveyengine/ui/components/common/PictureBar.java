...
public class PictureBar extends UINamingContainer {
	...
	public Integer getValueAttribute() {
		final Integer value = (Integer) getAttributes().get("value");
		return value;
	}

	public String getDotAttribute() {
		final String value = (String) getAttributes().get("dot");
		return value;
	}

	public String getArrowAttribute() {
		final String value = (String) getAttributes().get("arrow");
		return value;
	}

//	public String getMilestoneAttribute() {
//		final String value = (String) getAttributes().get("milestone");
//		return value;
//	}
	
	public Map getMilestonesAttribute() {
		final Map value = (Map) getAttributes().get("milestones");
		return value;
	}
	
	public de.his.zofar.presentation.surveyengine.ui.interfaces.INavigator getNavigatorAttribute() {
		final de.his.zofar.presentation.surveyengine.ui.interfaces.INavigator value = (de.his.zofar.presentation.surveyengine.ui.interfaces.INavigator) getAttributes().get("navigator");
		return value;
	}
