...
public class ZofarVerticalCheckboxResponseDomainRenderer extends
	...
	private int renderChildrenRecursiv(final List<UIComponent> components,
	 ...
	 * @throws IOException
	 */
	private int renderOption(final MultipleOption option,
	 ...
	 * @throws IOException
	 */
	private void renderUnitHeader(final UIComponent headerFacet,
