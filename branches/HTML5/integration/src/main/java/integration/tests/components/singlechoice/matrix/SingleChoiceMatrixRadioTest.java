...
public class SingleChoiceMatrixRadioTest extends AbstracTestBase {

	@Test
	public void testBasicSelection() throws Exception {
		final HtmlPage page = this.gotoPage("page3.html");
		...
		rdc_var.put("form:page3:msc:rd:i1:rd1", "msc1");
		rdc_var.put("form:page3:msc:rd:i2:rd1", "msc2");
		rdc_var.put("form:page3:msc:rd:i3:rd1", "msc3");
		
		rdc_options.put("form:page3:msc:rd:i1:rd1", CollectionClient.getInstance().asList("ao1","ao2","ao3","ao4","ao5","ao6"));
		rdc_options.put("form:page3:msc:rd:i2:rd1", CollectionClient.getInstance().asList("ao1","ao2","ao3","ao4","ao5","ao6"));
		rdc_options.put("form:page3:msc:rd:i3:rd1", CollectionClient.getInstance().asList("ao1","ao2","ao3","ao4","ao5","ao6"));
