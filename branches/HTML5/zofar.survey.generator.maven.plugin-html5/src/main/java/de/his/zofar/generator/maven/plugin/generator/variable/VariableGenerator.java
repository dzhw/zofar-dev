...
//			+ "//z:responseDomain[@variable='%1$s']//z:answerOption" + " | "
//			+ "//z:left[@variable='%1$s']//z:answerOption" + " | " + "//z:right[@variable='%1$s']//z:answerOption";
//	private static final String ANSWEROPTIONMISSINGS_QUERY = NAMESPACE_DECLARATION + " "
//			+ "//z:responseDomain[@variable='%1$s']//z:answerOption[@missing]" + " | "
//			+ "//z:left[@variable='%1$s']//z:answerOption[@missing]" + " | "
//			+ "//z:right[@variable='%1$s']//z:answerOption[@missing]";
//	private static final String BOOLEAN_ANSWEROPTION_QUERY = NAMESPACE_DECLARATION + " "
//			+ "//z:multipleChoice//z:answerOption[@variable='%1$s']" + " | "
//			+ "//z:matrixMultipleChoice//z:answerOption[@variable='%1$s']";
	...
	// * @param variableName
	// */
	// private final void addSingleChoiceAnswerOption(final VariableType variable) {
	// this.addVariableBean(variable, SINGLECHOICEANSWEROPTION_BEAN,
	// DEFAULT_VARIABLE_BEAN_SCOPE);
	// }
	...
	public final void addSingleChoiceAnswerOption(final VariableType variable, final QuestionnaireDocument source,
		...
		Map<String, Map<String, String>> data = parseSCData(variable.getName(), source);

		// if (options != null){
		// this.addSingleChoiceAnswerOption(variable,
		// this.createSingleChoiceOptionValues(this.parseValues(variable, options)),
		// this.createSingleChoiceOptionMissings(this.parseMissings(variable.getName(),
		// source)),this.createSingleChoiceOptionLabels(this.parseLabels(variable.getName(),
		// source)));
		//// this.addSingleChoiceAnswerOption(variable,
		// this.createSingleChoiceOptionValues(this.parseValues(variable, options)),
		// this.createSingleChoiceOptionMissings(this.parseMissings(variable.getName(),
		...
		// }else
		// this.addSingleChoiceAnswerOption(variable,
		// this.createSingleChoiceOptionValues(this.parseValues(variable.getName(),
		// source)),
		// this.createSingleChoiceOptionMissings(this.parseMissings(variable.getName(),
		// source)));
	...
	private Bean addVariableBean(final VariableType variable, final String className, final String scope,
		...
		System.out.println("addVarBean: " + variable.getName() + " (" + className + ")");
...
//			if ((QuestionSingleChoiceResponseDomainType.class).isAssignableFrom(rdc.getClass())) {
//				
//				final XmlObject[] tmp = ((QuestionSingleChoiceResponseDomainType)rdc).getAnswerOptionArray();
//				for(final XmlObject answer : tmp) { 
//					answers.add(answer);
//				}
//			}
...
//				if(option.isSetLabel2()) {
//					labelBuffer.append(option.getLabel2());
//				}
...
//
//		final String query = "declare namespace zofar='http://www.his.de/zofar/xml/questionnaire' //zofar:responseDomain[@variable='"
//				+ variableName + "']//zofar:answerOption";
...
//	}
	...
	public String findItemUidOfBoolean(final String variableName, final QuestionnaireDocument source) {
		...
		// final Object[] result =
		// source.selectPath(String.format(BOOLEAN_ANSWEROPTION_QUERY, variableName));
		//
		// for (final Object child : result) {
		...
		final XmlObject[] usingNodes = this.getByXPath(source,
...
//		System.out.println("itemUID for "+variableName+" : " + itemUid);
		return itemUid;
	}
	...
	public XmlObject[] getByXPath(final XmlObject root, final String query) {
		...
		if (!retrievedNamespaces.isEmpty()) {
