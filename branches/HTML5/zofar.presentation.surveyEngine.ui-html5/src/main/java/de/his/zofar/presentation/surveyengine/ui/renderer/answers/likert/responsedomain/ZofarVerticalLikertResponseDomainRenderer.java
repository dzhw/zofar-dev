...
public class ZofarVerticalLikertResponseDomainRenderer extends ZofarLikertResponseDomainRenderer {

	public static final String RENDERER_TYPE = "org.zofar.VerticalLikertResponseDomain";

	private static final Logger LOGGER = LoggerFactory.getLogger(ZofarVerticalLikertResponseDomainRenderer.class);
	...
	public void encodeBegin(final FacesContext context, final UIComponent component) throws IOException {
		...
		if (separateMissings) {
			additonalClasses = "zo-likert zo-likert-vertical zo-missingSeparated zo-missingSeparated-vertical";
		}
//		this.startTable(context.getResponseWriter(), component, additonalClasses);
	...
	public Point2D encodeChildrenHelper(final FacesContext context, final UIComponent component, final UIComponent child, Point2D rowPair) throws IOException {
