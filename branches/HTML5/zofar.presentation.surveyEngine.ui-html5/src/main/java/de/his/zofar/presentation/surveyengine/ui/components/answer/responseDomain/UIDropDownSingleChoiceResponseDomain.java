...
//		writer.writeAttribute("class", "zofar-question-singlechoice-responsedomaincombo", null);
//		writer.writeAttribute("size", 1, null);
//
//		String onchange = "deselectInputs('" + this.getClientId() + ":" + SEPARATED_ITEMS + "')";
//
...
//					final UIAttachedOpenQuestion aoq = ((SingleOption) child).getAttachedOpenQuestion();
...
//	private void encodeChildrenRecursively(final FacesContext context, final List<UIComponent> children) throws IOException {
//		for (final UIComponent child : children) {
//			if (SingleOption.class.isAssignableFrom(child.getClass())) {
...
//				this.encodeChildrenRecursively(context, ((UISort) child).sortChildren());
//			} else {
...
//	 * @param unit
//	 */
//	private void encodeUnit(final FacesContext context, final Section unit) throws IOException {
//		final ResponseWriter writer = context.getResponseWriter();
//
...
//			sectionTitle = JsfUtility.getInstance().evaluateValueExpression(this.getFacesContext(), ((UIText) facet).getContent(), String.class);
//		}
//		return sectionTitle;
//	}
...
//	 * @param child
//	 */
//	private void encodeOption(final FacesContext context, final SingleOption child) throws IOException {
...
//		if ((this.getValue() != null) && !((String) this.getValue()).isEmpty() && child.getId().endsWith((String) this.getValue())) {
...
//		}
//		writer.write(JsfUtility.getInstance().evaluateValueExpression(context, child.getLabel(), String.class));
//
...
//	 * @param context
//	 */
//	private void encodeSeparatedOptions(final FacesContext context) throws IOException {
//		if (!this.separatedOptions.isEmpty()) {
//			final ResponseWriter writer = context.getResponseWriter();
//
//			if (!this.isInMatrix) {
//				writer.startElement("table", this);
//				writer.writeAttribute("class", "zo-singlechoice-dropdown-table", null);
//			}
//
//			int rowIndex = 0;
...
//						writer.writeAttribute("class", this.getRowClazzes()[rowIndex++ % this.getRowClazzes().length], null);
//					}
//				}
//
...
//	 * @throws IOException
//	 */
//	private void encodeRadio(final FacesContext context, final SingleOption child) throws IOException {
//		final ResponseWriter writer = context.getResponseWriter();
//
...
//		}
//		writer.writeAttribute("name", this.getClientId() + ":" + SEPARATED_ITEMS, null);
...
//	}
//
//	private void encodeLabel(final FacesContext context, final SingleOption child) throws IOException {
//		final ResponseWriter writer = context.getResponseWriter();
//
...
//		}
//		label += JsfUtility.getInstance().evaluateValueExpression(context, child.getLabel(), String.class);
//		writer.write(label);
//
//		if (child.hasAttachedOpenQuestion()) {
...
//		final Boolean showValues = (Boolean) this.getAttributes().get("showValues");
//		return showValues;
//	}
	...
	public Boolean isMissingPriority() {
		// getAttributes().get("missingPriority");
		return true;
	}
//
