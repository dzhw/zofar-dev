 ...
 */
@Deprecated
//@FacesRenderer(componentFamily = UIDoubleMatrixItem.COMPONENT_FAMILY, rendererType = OldZofarDoubleMatrixItemRenderer.RENDERER_TYPE)
public class OldZofarDoubleMatrixItemRenderer extends ZofarAbstractDoubleMatrixRenderer {
	...
	public OldZofarDoubleMatrixItemRenderer() {
		super();
	}
	 ...
	 * @throws IOException
	 */
	private void renderAnswerOptions(final FacesContext context, final UIComponent component, final Side side) throws IOException {
		...
		if (!UISingleChoiceMatrixItemResponseDomain.class.isAssignableFrom(question.getClass())) {
			throw new IllegalStateException("The left and right side of an double matrix item must be of type UISingleChoiceMatrixItemResponseDomain. But it is: " + question.getClass());
		}
	 ...
	 * @param context
	 */
	private void renderQuestionColumn(final FacesContext context, final UIComponent component) throws IOException {
