...
public class CalendarRenderer extends Renderer {
	...
	public void encodeChildren(FacesContext context, UIComponent component) throws IOException {
		...
		// Controls Start
		// final String carouselId = component.getClientId(context).replace(':', '_') +
		// "_carousel";
		writer.startElement("div", component);
	...
	public void encodeEnd(FacesContext context, UIComponent component) throws IOException {
		...
		//
		// writer.startElement("a", component);
		// writer.writeAttribute("class", "btn btn-secondary carousel-control-prev",
		// null);
		// writer.writeAttribute("href", "#" + carouselId, null);
		// writer.writeAttribute("role", "button", null);
		// writer.writeAttribute("data-slide", "prev", null);
		...
		//
		// writer.startElement("a", component);
		// writer.writeAttribute("class", "btn btn-secondary carousel-control-next",
		// null);
		// writer.writeAttribute("href", "#" + carouselId, null);
		// writer.writeAttribute("role", "button", null);
		// writer.writeAttribute("data-slide", "next", null);
