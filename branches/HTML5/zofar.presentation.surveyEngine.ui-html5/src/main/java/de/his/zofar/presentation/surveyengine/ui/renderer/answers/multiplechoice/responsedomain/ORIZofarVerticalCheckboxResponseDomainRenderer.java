...
// MultipleChoiceResponseDomain.COMPONENT_FAMILY, rendererType =
// ORIZofarVerticalCheckboxResponseDomainRenderer.RENDERER_TYPE)
public class ORIZofarVerticalCheckboxResponseDomainRenderer extends ZofarMultipleChoiceResponseDomainRenderer {

	public static final String RENDERER_TYPE = "org.zofar.VerticalCheckboxResponseDomain";

	private static final Logger LOGGER = LoggerFactory.getLogger(ORIZofarVerticalCheckboxResponseDomainRenderer.class);
	...
	public synchronized void encodeBegin(final FacesContext context, final UIComponent component) throws IOException {
		...
		if (separateMissings) {
			additonalClasses = "zo-missingSeparated zo-missingSeparated-vertical";
		}
...
//		final String[] rowClasses = this.itemClassesToArray((String) component.getAttributes().get("rowClasses"));
