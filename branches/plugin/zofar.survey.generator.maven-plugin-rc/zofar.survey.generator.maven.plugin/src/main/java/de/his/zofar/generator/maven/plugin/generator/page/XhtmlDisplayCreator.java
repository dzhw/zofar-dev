...
public class XhtmlDisplayCreator extends AbstractXhtmlElementCreator implements IXhtmlCreator {
	...
	@Override
	public void addToSection(IdentificationalType source, com.sun.java.jsf.composite.container.SectionType target, boolean root) throws XmlException {
		if (source == null)
			return;
		// LOGGER.info("add to Section : {}",source.getClass());
	...
	public void addToSort(IdentificationalType source, SortType target) throws XmlException {
		if (source == null)
			return;
		// LOGGER.info("add to Sort : {}",source.getClass());
		if (!(DisplayType.class).isAssignableFrom(source.getClass()))
			return;
	...
	private void addContainer(final DisplayType display, final com.sun.java.jsf.composite.common.IdentificationalType target, final boolean root) throws XmlException {
		if (target == null)
			return;
		if (display == null)
			return;
...
//			LOGGER.info("add display child {} {}",element.getDomNode().getNodeName(),element.getClass());
			...
			} else if ((eu.dzhw.zofar.xml.display.impl.DisplayTextTypeImpl.class).isAssignableFrom(element.getClass())) {
				addText((eu.dzhw.zofar.xml.display.impl.DisplayTextTypeImpl) element, displayContainer);
			} else if ((eu.dzhw.zofar.xml.display.impl.DisplayReloadTypeImpl.class).isAssignableFrom(element.getClass())) {
	...
	private void addReload(final eu.dzhw.zofar.xml.display.impl.DisplayReloadTypeImpl source, final com.sun.java.jsf.composite.display.DisplayType displayContainer) throws XmlException {
//		LOGGER.info("addReload {} {}",source, displayContainer);
		if (source == null)
			return;
		if (displayContainer == null)
			return;
	...
	private void addTable(final eu.dzhw.zofar.xml.display.impl.DisplayTableTypeImpl table, final com.sun.java.jsf.composite.display.DisplayType displayContainer) {
		if (table == null)
			return;
		if (displayContainer == null)
			return;
		...
		if (header != null) {
			final com.sun.java.jsf.composite.display.DisplayTableHeaderType xmhtlTableHeader = xhtmlTable.addNewHeader();
		...
		if (body != null) {
			...
			if (rows != null) {
				for (final DisplayTableRowType row : rows) {
					final com.sun.java.jsf.composite.display.DisplayTableRowType xmhtlTableBodyRow = xmhtlTableBody.addNewRow();
					...
					if (items != null) {
						for (final eu.dzhw.zofar.xml.display.DisplayTableItemType item : items) {
							final com.sun.java.jsf.composite.display.DisplayTableItemType xhtmlItem = xmhtlTableBodyRow.addNewItem();

							final String itemUid = item.getUid();
							xhtmlItem.setId(itemUid);

							for (final XmlObject element : item.selectPath(SELECT_PATH_IN_ORDER)) {
								if ((eu.dzhw.zofar.xml.display.DisplayTextType.class).isAssignableFrom(element.getClass())) {
									...
									final com.sun.java.jsf.composite.common.JumperType xhtmlJumper = xhtmlItem.addNewJumper();
	...
	private void addText(final eu.dzhw.zofar.xml.display.DisplayTextType text, final com.sun.java.jsf.composite.display.DisplayTableHeaderType container) {
		if (text == null)
			return;
		if (container == null)
			return;
	...
	private void addText(final eu.dzhw.zofar.xml.display.DisplayTextType text, final com.sun.java.jsf.composite.display.DisplayTableItemType container) {
		if (text == null)
			return;
		if (container == null)
			return;
	...
	private void addText(final eu.dzhw.zofar.xml.display.DisplayTextType text, final com.sun.java.jsf.composite.display.DisplayType container) {
		if (text == null)
			return;
		if (container == null)
			return;
	...
	private void configureText(final eu.dzhw.zofar.xml.display.DisplayTextType text, final com.sun.java.jsf.composite.display.DisplayTextType xhtmlText) {
		if (text == null)
			return;
		if (xhtmlText == null)
			return;
