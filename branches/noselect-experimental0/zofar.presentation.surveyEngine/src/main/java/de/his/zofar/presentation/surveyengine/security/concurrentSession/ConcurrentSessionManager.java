...
public class ConcurrentSessionManager implements Serializable {
	...
	// Used in RequestSecurityListener to check for valid session
	...
	// Called by LoginController when Authentication was successfull
	...
	// Called by SessionSecurityListener when sessionDestroyed is triggered
	...
	// called by RequestSecurityListener to invalidate takeover-Sessions
